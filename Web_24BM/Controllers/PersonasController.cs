...
namespace Web_24BM.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Nombre,Apellido,CURP,FechaNacimiento,RFC,Area_De_Trabajo")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Nombre,Apellido,CURP,FechaNacimiento,RFC,Area_De_Trabajo")] Persona persona)
        {
            if (id != persona.id)
            {
                return NotFound();
